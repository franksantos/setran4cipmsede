...
@section('page_header_title', 'Cadastro de Auto de Infra&ccedil;&atilde;o de Tr&acirc;nsito Rodovi&aacute;rio')
@section('descricao_pagina_opcional', 'Preencha o cadastro para adicionar um novo AITR')
@section('content')
        <!-- Conteúdo -->
<div class="box box-primary">
    ...
    <form action="{{route('aitr.store')}}" method="POST">
        {!! csrf_field() !!}
        <div class="box-body">
            <!-- CIDADES DA 4CIPM -->
